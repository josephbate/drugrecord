...
import org.openmrs.module.drugrecord.api.impl.DrugrecordServiceImpl;
import static org.mockito.Mockito.*;
import static org.hamcrest.Matchers.*;
import static org.junit.Assert.*;

/**
 * This is a unit test, which verifies logic in DrugrecordService. It doesn't extend
 * BaseModuleContextSensitiveTest, thus it is run without the in-memory DB and Spring context.
 */
public class DrugrecordServiceTest {
	
	@InjectMocks
	DrugrecordServiceImpl basicModuleService;
